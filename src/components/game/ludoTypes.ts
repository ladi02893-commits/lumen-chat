...
export const MAIN_PATH_COORDS: CellCoord[] = [
  // 0 - 4: Red Start moving right
  { r: 6, c: 1 }, { r: 6, c: 2 }, { r: 6, c: 3 }, { r: 6, c: 4 }, { r: 6, c: 5 },
  // 5 - 10: Going UP towards Green Base
  { r: 5, c: 6 }, { r: 4, c: 6 }, { r: 3, c: 6 }, { r: 2, c: 6 }, { r: 1, c: 6 }, { r: 0, c: 6 },
  // 11 - 12: Top turn
  { r: 0, c: 7 }, { r: 0, c: 8 },
  // 13 - 17: Green Start going DOWN
  { r: 1, c: 8 }, { r: 2, c: 8 }, { r: 3, c: 8 }, { r: 4, c: 8 }, { r: 5, c: 8 },
  // 18 - 23: Going RIGHT towards Yellow Base
  { r: 6, c: 9 }, { r: 6, c: 10 }, { r: 6, c: 11 }, { r: 6, c: 12 }, { r: 6, c: 13 }, { r: 6, c: 14 },
  // 24 - 25: Right turn
  { r: 7, c: 14 }, { r: 8, c: 14 },
  // 26 - 30: Yellow Start going LEFT
  { r: 8, c: 13 }, { r: 8, c: 12 }, { r: 8, c: 11 }, { r: 8, c: 10 }, { r: 8, c: 9 },
  // 31 - 36: Going DOWN towards Blue Base
  { r: 9, c: 8 }, { r: 10, c: 8 }, { r: 11, c: 8 }, { r: 12, c: 8 }, { r: 13, c: 8 }, { r: 14, c: 8 },
  // 37 - 38: Bottom turn
  { r: 14, c: 7 }, { r: 14, c: 6 },
  // 39 - 43: Blue Start going UP
  { r: 13, c: 6 }, { r: 12, c: 6 }, { r: 11, c: 6 }, { r: 10, c: 6 }, { r: 9, c: 6 },
  // 44 - 49: Going LEFT towards Red Base
...
// Safe spots on the 52-step track
export const SAFE_INDICES = [0, 8, 13, 21, 26, 34, 39, 47];

// Base Token Home slots coordinates for rendering inside the 6x6 home bases
export const BASE_SLOT_COORDS: Record<PlayerColor, CellCoord[]> = {
  red: [
    { r: 1.8, c: 1.8 }, { r: 1.8, c: 4.2 }, { r: 4.2, c: 1.8 }, { r: 4.2, c: 4.2 }
  ],
  green: [
    { r: 1.8, c: 10.8 }, { r: 1.8, c: 13.2 }, { r: 4.2, c: 10.8 }, { r: 4.2, c: 13.2 }
  ],
  yellow: [
    { r: 10.8, c: 10.8 }, { r: 10.8, c: 13.2 }, { r: 13.2, c: 10.8 }, { r: 13.2, c: 13.2 }
  ],
  blue: [
    { r: 10.8, c: 1.8 }, { r: 10.8, c: 4.2 }, { r: 13.2, c: 1.8 }, { r: 13.2, c: 4.2 }
  ],
};
